...
?>
  ...
  <div class="div_confirm">
    ...
    <form method="post">
      <input type= "hidden" name= "participant_ID" value=<?php echo $_POST['participant_ID'];?>>  <!-- REPOST PARTICIPANT_ID -->
...
if (isset($_POST["confirm_yes"])) { // EXECUTE IF YES IS CLICKED
  $participant_ID = $_POST['participant_ID']; // GET REPOSTED PARTICIPANT_ID
  // SQL QUERY TO DELETE THE POSTED PARTICIPANT
...
$participant_ID = $_POST["participant_ID"]; // GET POSTED PARTICIPANT_ID

$field = array(array());	// DECLARE MULTI-DIMENSIONAL ASSOCIATIVE ARRAY
$field_names = array('student_number','participant_level','previously_registered','centre_name','eDofe_ID','pathway_enrichment','on_bursary','first_name','last_name','gender','date_of_birth','primary_language','shoe_size','email_address','mobile_number','telephone','address','town_city','county','post_code','emergency_name_1','emergency_mobile_1','emergency_home_1','emergency_work_1','relationship_1','emergency_name_2','emergency_mobile_2','emergency_home_2','emergency_work_2','relationship_2','doctor_name','doctor_telephone','medical_condition','medicine','injection_date','food_dislikes','other_info','username');
...
if(isset($_POST["confirm_update"])) {
  ...
  // VALIDATE STUDENT NUMBER
	...
	$field['emergency_mobile_1'] = presence_check('emergency_mobile_1','Please enter an mobile number');
	...
	$field['relationship_2'] = presence_check('relationship_1','Please enter your relationship');
